...
public class NetworkModule {
    ...
    public NetworkModule(String url, BaseActivity baseActivity) {
...
//                })
    ...
    @Provides
    @Singleton
    public UserNetworking providesUserNetworking(UserService userService){
        return new UserNetworking(userService);
    }
